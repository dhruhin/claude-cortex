...
2. **Handle missing**: If not in `5. People/`, invoke /create-person first
...
8. **Route to**: `5. People/[Name]/Details/current.md` under ## Tasks
...
Destination: `5. People/Sarah/Details/current.md`
